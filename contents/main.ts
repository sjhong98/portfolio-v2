const mainContent = {
    about: 
`1년 9개월 동안 웹·앱 기획·개발·운영 스타트업 아이비알도스에서 풀스택 개발자로 근무하며 총 4개의 서비스 개발과 3개의 사내 사이드 프로젝트에 참여했습니다. 총 7개 프로젝트에서 프론트엔드 개발을 담당했고, 이 중 4개 프로젝트에서 백엔드까지 담당하여 풀스택 개발을 진행했습니다.
