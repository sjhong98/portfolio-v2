...
자연스럽게 서비스에 대한 오너쉽을 가지고 개발 및 운영에 임할 수 있었고, 그 결과 팀원들도 해당 플랫폼에 대한 업무는 저에게 전담함으로써 제 책임감을 인정 받기도 했습니다. 이 경험을 통해 “내가 만든 서비스를 내가 끝까지 책임진다”는 태도를 자연스럽게 갖추게 되었습니다.`
                ...
                {
                    title: '환경 개선을 위한 노력',
                    content: `이러한 환경 속에서 개발 환경 개선과 업무 효율화에도 관심을 기울였습니다. 실제로 Cursor AI와 Claude Code를 적극 활용하여 업무 시간을 단축하였으며, AI 사용성을 높이기 위해 drizzle-orm의 schema pull 기능을 활용한 DB 스키마 자동화 연동 시 타입을 자동으로 생성하는 스크립트를 생성하였습니다. 이로써 타입 지정 과정을 단축하고 AI가 더 다양한 범위에서 완성도 높은 코드를 작성할 수 있도록 하였습니다.
